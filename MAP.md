...
**server v0.2.0 已实现；client v0.1.11（+ 已提交、未发版的「阅读器沉浸态收官 v0.4~v0.8」，2026-09-11，见下）。**
...
13. `client/docs/STYLE.md` —— **渲染层风格基线（v0.8，准则）**：文字优先（P1）/ 全局统一字体（Times + 源流明）/ 字号阶梯 / **中文排版 §4** / **阅读器沉浸态 §5.8（桌与纸、阅读页零控件、覆盖式侧边栏、目录挂载线、遮罩高亮）** / **可调参数清单 §5.9** / 例外清单 / 禁区与验收 / 激进档回退机制
...
- **client v0.1.11 + 已提交未发版（2026-09-11，阅读器沉浸态收官 v0.4~v0.8）**：
